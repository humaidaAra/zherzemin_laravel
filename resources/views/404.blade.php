...
<body>
    <section class="notFound">
        <div class="img">
            {{-- https://assets.codepen.io/5647096/backToTheHomepage.png --}}
            {{-- https://assets.codepen.io/5647096/Delorean.png --}}
        <img src="{{ asset('images/backToTheHomepage.webp') }}" alt="Back to the Homepage"/>
        <img src="{{ asset('images/Delorean.webp')}}" alt="El Delorean, El Doc y Marti McFly"/>
        </div>
        <div class="text">
        <h1>404</h1>
