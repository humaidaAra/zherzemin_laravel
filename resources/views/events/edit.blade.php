        ...
        <div class="row">
            <div class="col">
                ...
                <div id="form-ar" style="display:none;">
                    <div>
                        <input type="text" name="title_ar" value="{{ $event->title_ar }}" placeholder="Title (آر)">
                    </div>
                    <div>
                        <textarea name="description_ar" placeholder="Short Description (آر)" rows="2">{{ $event->description_ar }}</textarea>
                    </div>
                    <div>
                        <textarea name="body_ar" class="bodies" placeholder="Content (آر)" rows="6">{{ $event->body_ar }}</textarea>
                    </div>
                </div>
            </div>
            <div class="col-1"></div>
